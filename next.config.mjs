        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://storage.banyalabs.com https://*.tile.openstreetmap.org https://api.lenco.co https://openrouter.ai https://api.openai.com",
              "frame-src 'self' https://storage.banyalabs.com https://api.lenco.co",
